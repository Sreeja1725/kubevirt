...
func (in *CPU) DeepCopyInto(out *CPU) {
	*out = *in
	...
	in.CPUSource.DeepCopyInto(&out.CPUSource)
	if in.NUMA != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CPUSource) DeepCopyInto(out *CPUSource) {
	*out = *in
	if in.DRA != nil {
		in, out := &in.DRA, &out.DRA
		*out = make([]ClaimRequest, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CPUSource.
func (in *CPUSource) DeepCopy() *CPUSource {
	if in == nil {
		return nil
	}
	out := new(CPUSource)
