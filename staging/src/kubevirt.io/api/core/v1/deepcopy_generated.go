...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CPUDRAConfiguration) DeepCopyInto(out *CPUDRAConfiguration) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CPUDRAConfiguration.
func (in *CPUDRAConfiguration) DeepCopy() *CPUDRAConfiguration {
	if in == nil {
		return nil
	}
	out := new(CPUDRAConfiguration)
	in.DeepCopyInto(out)
	return out
}
